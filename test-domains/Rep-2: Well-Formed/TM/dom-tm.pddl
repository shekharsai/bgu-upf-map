...
( :PREDICATES
	...
	( NEXT-ACTIVITY-3-MOVE-TABLE-2 ?TABLE0 - TABLE ?ROOM1 - ROOM ?ROOM2 - ROOM )
	( NEXT-ACTIVITY-3-MOVE-TABLE-3 ?TABLE0 - TABLE ?ROOM1 - ROOM ?ROOM2 - ROOM )
	( P-ACTIVITY-3-MOVE-TABLE ?AGENT0 - AGENT ?TABLE1 - TABLE ?ROOM2 - ROOM ?ROOM3 - ROOM )
	...
	( NEXT-ACTIVITY-3-LIFT-TABLE-2 ?TABLE0 - TABLE ?ROOM1 - ROOM )
	( NEXT-ACTIVITY-3-LIFT-TABLE-3 ?TABLE0 - TABLE ?ROOM1 - ROOM )
	( P-ACTIVITY-3-LIFT-TABLE ?AGENT0 - AGENT ?TABLE1 - TABLE ?ROOM2 - ROOM )
	( P-ACTIVITY-2-DROP-TABLE ?AGENT0 - AGENT ?TABLE1 - TABLE )
	( P-ACTIVITY-3-DROP-TABLE ?AGENT0 - AGENT ?TABLE1 - TABLE )
	( P-DROP-TABLE ?AGENT0 - AGENT ?TABLE1 - TABLE )
	( NEXT-ACTIVITY-2-DROP-TABLE-2 ?TABLE0 - TABLE )
	( NEXT-ACTIVITY-3-DROP-TABLE-2 ?TABLE0 - TABLE )
	( NEXT-ACTIVITY-3-DROP-TABLE-3 ?TABLE0 - TABLE )
)
  ...
  :PRECONDITION
	( AND
		...
		( FORALL
			( ?AGENT7 - AGENT )
			( AND
				( NOT ( P-MOVE-TABLE ?AGENT7 ?TABLE2 ?ROOM3 ?ROOM4 ) )
			)
		)
	)
  :EFFECT
...
( :ACTION DO-ACTIVITY-3-MOVE-TABLE-1
  :PARAMETERS ( ?AGENT0 - AGENT ?TABLE3 - TABLE ?ROOM4 - ROOM ?ROOM5 - ROOM ?AGENT-COUNT6 - AGENT-COUNT ?AGENT-COUNT7 - AGENT-COUNT )
  :PRECONDITION
	( AND
		...
		( FORALL
			( ?AGENT8 - AGENT )
			( AND
				( NOT ( P-MOVE-TABLE ?AGENT8 ?TABLE3 ?ROOM4 ?ROOM5 ) )
			)
		)
	)
  :EFFECT
	( AND
		...
		( IN-JOINT )
		( NEXT-ACTIVITY-3-MOVE-TABLE-2 ?TABLE3 ?ROOM4 ?ROOM5 )
		( P-ACTIVITY-3-MOVE-TABLE ?AGENT0 ?TABLE3 ?ROOM4 ?ROOM5 )
		( P-MOVE-TABLE ?AGENT0 ?TABLE3 ?ROOM4 ?ROOM5 )
	)
)
( :ACTION DO-ACTIVITY-3-MOVE-TABLE-2
  :PARAMETERS ( ?AGENT0 - AGENT ?TABLE3 - TABLE ?ROOM4 - ROOM ?ROOM5 - ROOM ?AGENT-COUNT6 - AGENT-COUNT ?AGENT-COUNT7 - AGENT-COUNT )
  :PRECONDITION
	( AND
		( LIFTING ?AGENT0 ?TABLE3 )
  ...
  :EFFECT
	( AND
		...
		( NOT ( COUNT-V2 ?AGENT-COUNT6 ) )
		( COUNT-V2 ?AGENT-COUNT7 )
		( NOT ( NEXT-ACTIVITY-3-MOVE-TABLE-2 ?TABLE3 ?ROOM4 ?ROOM5 ) )
		( NEXT-ACTIVITY-3-MOVE-TABLE-3 ?TABLE3 ?ROOM4 ?ROOM5 )
		( P-MOVE-TABLE ?AGENT0 ?TABLE3 ?ROOM4 ?ROOM5 )
	)
)
( :ACTION DO-ACTIVITY-3-MOVE-TABLE-3
  :PARAMETERS ( ?AGENT0 - AGENT ?TABLE3 - TABLE ?ROOM4 - ROOM ?ROOM5 - ROOM ?AGENT-COUNT6 - AGENT-COUNT ?AGENT-COUNT7 - AGENT-COUNT )
  :PRECONDITION
	( AND
		( LIFTING ?AGENT0 ?TABLE3 )
  ...
  :EFFECT
	( AND
		...
		( IN ?AGENT0 ?ROOM5 )
		( NOT ( IN-JOINT ) )
		( NOT ( NEXT-ACTIVITY-3-MOVE-TABLE-3 ?TABLE3 ?ROOM4 ?ROOM5 ) )
		( TAKEN ?AGENT0 )
		( NOT ( COUNT-V2 ?AGENT-COUNT6 ) )
		( COUNT-V2 ?AGENT-COUNT7 )
		( P-MOVE-TABLE ?AGENT0 ?TABLE3 ?ROOM4 ?ROOM5 )
...
( :ACTION END-V2
  ...
  :EFFECT
	( AND
		...
		( FORALL
			( ?AGENT4 - AGENT )
			( NOT ( P-ACTIVITY-3-MOVE-TABLE ?AGENT4 ?TABLE0 ?ROOM1 ?ROOM2 ) )
		)
		( FORALL
			( ?AGENT4 - AGENT )
			( NOT ( TAKEN ?AGENT4 ) )
  ...
  :PRECONDITION
	( AND
		...
		( FORALL
			( ?AGENT6 - AGENT )
			( AND
				( NOT ( P-LIFT-TABLE ?AGENT6 ?TABLE2 ?ROOM3 ) )
			)
		)
	)
  :EFFECT
...
( :ACTION DO-ACTIVITY-3-LIFT-TABLE-1
  :PARAMETERS ( ?AGENT0 - AGENT ?TABLE3 - TABLE ?ROOM4 - ROOM ?AGENT-COUNT5 - AGENT-COUNT ?AGENT-COUNT6 - AGENT-COUNT )
  :PRECONDITION
	( AND
		( AVAILABLE ?AGENT0 )
		( IN ?AGENT0 ?ROOM4 )
		...
		( FORALL
			( ?AGENT7 - AGENT )
			( AND
				( NOT ( P-LIFT-TABLE ?AGENT7 ?TABLE3 ?ROOM4 ) )
			)
		)
	)
  :EFFECT
	( AND
		...
		( IN-JOINT )
		( NEXT-ACTIVITY-3-LIFT-TABLE-2 ?TABLE3 ?ROOM4 )
		( P-ACTIVITY-3-LIFT-TABLE ?AGENT0 ?TABLE3 ?ROOM4 )
		( P-LIFT-TABLE ?AGENT0 ?TABLE3 ?ROOM4 )
	)
)
( :ACTION DO-ACTIVITY-3-LIFT-TABLE-2
  :PARAMETERS ( ?AGENT0 - AGENT ?TABLE3 - TABLE ?ROOM4 - ROOM ?AGENT-COUNT5 - AGENT-COUNT ?AGENT-COUNT6 - AGENT-COUNT )
  :PRECONDITION
	( AND
		( AVAILABLE ?AGENT0 )
  ...
  :EFFECT
	( AND
		...
		( NOT ( COUNT-V3 ?AGENT-COUNT5 ) )
		( COUNT-V3 ?AGENT-COUNT6 )
		( NOT ( NEXT-ACTIVITY-3-LIFT-TABLE-2 ?TABLE3 ?ROOM4 ) )
		( NEXT-ACTIVITY-3-LIFT-TABLE-3 ?TABLE3 ?ROOM4 )
		( P-LIFT-TABLE ?AGENT0 ?TABLE3 ?ROOM4 )
	)
)
( :ACTION DO-ACTIVITY-3-LIFT-TABLE-3
  :PARAMETERS ( ?AGENT0 - AGENT ?TABLE3 - TABLE ?ROOM4 - ROOM ?AGENT-COUNT5 - AGENT-COUNT ?AGENT-COUNT6 - AGENT-COUNT )
  :PRECONDITION
	( AND
		( AVAILABLE ?AGENT0 )
  ...
  :EFFECT
	( AND
		...
		( INTACT ?TABLE3 )
		( NOT ( IN-JOINT ) )
		( NOT ( NEXT-ACTIVITY-3-LIFT-TABLE-3 ?TABLE3 ?ROOM4 ) )
		( TAKEN ?AGENT0 )
		( NOT ( COUNT-V3 ?AGENT-COUNT5 ) )
		( COUNT-V3 ?AGENT-COUNT6 )
		( P-LIFT-TABLE ?AGENT0 ?TABLE3 ?ROOM4 )
...
( :ACTION END-V3
  ...
  :EFFECT
	( AND
		...
		( FORALL
			( ?AGENT3 - AGENT )
			( NOT ( P-ACTIVITY-3-LIFT-TABLE ?AGENT3 ?TABLE0 ?ROOM1 ) )
		)
		( FORALL
			( ?AGENT3 - AGENT )
			( NOT ( TAKEN ?AGENT3 ) )
  ...
  :PRECONDITION
	( AND
		...
		( FORALL
			( ?AGENT6 - AGENT )
			( AND
				( NOT ( P-DROP-TABLE ?AGENT6 ?TABLE2 ) )
			)
		)
	)
  :EFFECT
...
( :ACTION DO-ACTIVITY-3-DROP-TABLE-1
  :PARAMETERS ( ?AGENT0 - AGENT ?TABLE3 - TABLE ?ROOM4 - ROOM ?AGENT-COUNT5 - AGENT-COUNT ?AGENT-COUNT6 - AGENT-COUNT )
  :PRECONDITION
	( AND
		( IN ?AGENT0 ?ROOM4 )
		...
		( FORALL
			( ?AGENT7 - AGENT )
			( AND
				( NOT ( P-DROP-TABLE ?AGENT7 ?TABLE3 ) )
			)
		)
	)
  :EFFECT
	( AND
		( NOT ( LIFTING ?AGENT0 ?TABLE3 ) )
		( INROOM ?TABLE3 ?ROOM4 )
		( AVAILABLE ?AGENT0 )
		( INTACT ?TABLE3 )
		( NOT ( CHARGED ?AGENT0 ) )
		( TAKEN ?AGENT0 )
		( NOT ( COUNT-V4 ?AGENT-COUNT5 ) )
		( COUNT-V4 ?AGENT-COUNT6 )
		( IN-JOINT )
		( NEXT-ACTIVITY-3-DROP-TABLE-2 ?TABLE3 )
		( P-ACTIVITY-3-DROP-TABLE ?AGENT0 ?TABLE3 )
		( P-DROP-TABLE ?AGENT0 ?TABLE3 )
	)
)
( :ACTION DO-ACTIVITY-3-DROP-TABLE-2
  :PARAMETERS ( ?AGENT0 - AGENT ?TABLE3 - TABLE ?ROOM4 - ROOM ?AGENT-COUNT5 - AGENT-COUNT ?AGENT-COUNT6 - AGENT-COUNT )
  :PRECONDITION
	( AND
		( IN ?AGENT0 ?ROOM4 )
  ...
  :EFFECT
	( AND
		...
		( NOT ( COUNT-V4 ?AGENT-COUNT5 ) )
		( COUNT-V4 ?AGENT-COUNT6 )
		( NOT ( NEXT-ACTIVITY-3-DROP-TABLE-2 ?TABLE3 ) )
		( NEXT-ACTIVITY-3-DROP-TABLE-3 ?TABLE3 )
		( P-DROP-TABLE ?AGENT0 ?TABLE3 )
	)
)
( :ACTION DO-ACTIVITY-3-DROP-TABLE-3
  :PARAMETERS ( ?AGENT0 - AGENT ?TABLE3 - TABLE ?ROOM4 - ROOM ?AGENT-COUNT5 - AGENT-COUNT ?AGENT-COUNT6 - AGENT-COUNT )
  :PRECONDITION
	( AND
		( IN ?AGENT0 ?ROOM4 )
  ...
  :EFFECT
	( AND
		...
		( NOT ( CHARGED ?AGENT0 ) )
		( NOT ( IN-JOINT ) )
		( NOT ( NEXT-ACTIVITY-3-DROP-TABLE-3 ?TABLE3 ) )
		( TAKEN ?AGENT0 )
		( NOT ( COUNT-V4 ?AGENT-COUNT5 ) )
		( COUNT-V4 ?AGENT-COUNT6 )
		( P-DROP-TABLE ?AGENT0 ?TABLE3 )
...
( :ACTION END-V4
  ...
  :EFFECT
	( AND
		...
		( FORALL
			( ?AGENT2 - AGENT )
			( NOT ( P-ACTIVITY-3-DROP-TABLE ?AGENT2 ?TABLE0 ) )
		)
		( FORALL
			( ?AGENT2 - AGENT )
			( NOT ( TAKEN ?AGENT2 ) )
...
;Domain compilation time is: 0.00505
