...
( :PREDICATES
	...
	( AFREE )
	( IN-JOINT )
	( NEXT-ACTIVITY-MOVE-TABLE-MOVE-TABLE-2 ?TABLE0 - TABLE ?ROOM1 - ROOM ?ROOM2 - ROOM )
	( P-ACTIVITY-MOVE-TABLE-MOVE-TABLE ?AGENT0 - AGENT ?TABLE1 - TABLE ?ROOM2 - ROOM ?ROOM3 - ROOM )
	( P-MOVE-TABLE ?AGENT0 - AGENT ?TABLE1 - TABLE ?ROOM2 - ROOM ?ROOM3 - ROOM )
	( P-LIFT-TABLE ?AGENT0 - AGENT ?TABLE1 - TABLE ?ROOM2 - ROOM )
	( NEXT-ACTIVITY-LIFT-TABLE-LIFT-TABLE-2 ?TABLE0 - TABLE ?ROOM1 - ROOM )
	( P-ACTIVITY-LIFT-TABLE-LIFT-TABLE ?AGENT0 - AGENT ?TABLE1 - TABLE ?ROOM2 - ROOM )
	( P-ACTIVITY-DROP-TABLE-DROP-TABLE ?AGENT0 - AGENT ?TABLE1 - TABLE )
	( P-DROP-TABLE ?AGENT0 - AGENT ?TABLE1 - TABLE )
	( NEXT-ACTIVITY-DROP-TABLE-DROP-TABLE-2 ?TABLE0 - TABLE )
)
...
( :ACTION DO-ACTIVITY-MOVE-TABLE-MOVE-TABLE-1
  ...
  :EFFECT
	( AND
		...
		( IN-JOINT )
		( NEXT-ACTIVITY-MOVE-TABLE-MOVE-TABLE-2 ?TABLE2 ?ROOM3 ?ROOM4 )
		( P-ACTIVITY-MOVE-TABLE-MOVE-TABLE ?AGENT0 ?TABLE2 ?ROOM3 ?ROOM4 )
		( P-MOVE-TABLE ?AGENT0 ?TABLE2 ?ROOM3 ?ROOM4 )
	)
)
( :ACTION DO-ACTIVITY-MOVE-TABLE-MOVE-TABLE-2
  :PARAMETERS ( ?AGENT0 - AGENT ?TABLE2 - TABLE ?ROOM3 - ROOM ?ROOM4 - ROOM ?AGENT-COUNT5 - AGENT-COUNT ?AGENT-COUNT6 - AGENT-COUNT )
  :PRECONDITION
	( AND
		( LIFTING ?AGENT0 ?TABLE2 )
  ...
  :EFFECT
	( AND
		...
		( IN ?AGENT0 ?ROOM4 )
		( NOT ( IN-JOINT ) )
		( NOT ( NEXT-ACTIVITY-MOVE-TABLE-MOVE-TABLE-2 ?TABLE2 ?ROOM3 ?ROOM4 ) )
		( TAKEN ?AGENT0 )
		( NOT ( COUNT-V2 ?AGENT-COUNT5 ) )
		( COUNT-V2 ?AGENT-COUNT6 )
	)
...
( :ACTION END-V2
  ...
  :EFFECT
	( AND
		...
		( FORALL
			( ?AGENT4 - AGENT )
			( NOT ( P-ACTIVITY-MOVE-TABLE-MOVE-TABLE ?AGENT4 ?TABLE0 ?ROOM1 ?ROOM2 ) )
		)
		( FORALL
			( ?AGENT4 - AGENT )
...
( :ACTION DO-ACTIVITY-LIFT-TABLE-LIFT-TABLE-1
  ...
  :EFFECT
	( AND
		...
		( IN-JOINT )
		( NEXT-ACTIVITY-LIFT-TABLE-LIFT-TABLE-2 ?TABLE2 ?ROOM3 )
		( P-ACTIVITY-LIFT-TABLE-LIFT-TABLE ?AGENT0 ?TABLE2 ?ROOM3 )
		( P-LIFT-TABLE ?AGENT0 ?TABLE2 ?ROOM3 )
	)
)
( :ACTION DO-ACTIVITY-LIFT-TABLE-LIFT-TABLE-2
  :PARAMETERS ( ?AGENT0 - AGENT ?TABLE2 - TABLE ?ROOM3 - ROOM ?AGENT-COUNT4 - AGENT-COUNT ?AGENT-COUNT5 - AGENT-COUNT )
  :PRECONDITION
	( AND
		( AVAILABLE ?AGENT0 )
  ...
  :EFFECT
	( AND
		...
		( INTACT ?TABLE2 )
		( NOT ( IN-JOINT ) )
		( NOT ( NEXT-ACTIVITY-LIFT-TABLE-LIFT-TABLE-2 ?TABLE2 ?ROOM3 ) )
		( TAKEN ?AGENT0 )
		( NOT ( COUNT-V3 ?AGENT-COUNT4 ) )
		( COUNT-V3 ?AGENT-COUNT5 )
	)
...
( :ACTION END-V3
  ...
  :EFFECT
	( AND
		...
		( FORALL
			( ?AGENT3 - AGENT )
			( NOT ( P-ACTIVITY-LIFT-TABLE-LIFT-TABLE ?AGENT3 ?TABLE0 ?ROOM1 ) )
		)
		( FORALL
			( ?AGENT3 - AGENT )
			( NOT ( TAKEN ?AGENT3 ) )
...
( :ACTION DO-DROP-TABLE
  ...
  :PRECONDITION
	( AND
		...
		( FORALL
			( ?AGENT5 - AGENT )
			( NOT ( P-ACTIVITY-DROP-TABLE-DROP-TABLE ?AGENT5 ?TABLE1 ) )
		)
		( FORALL
			( ?AGENT5 - AGENT )
			( AND
...
( :ACTION DO-ACTIVITY-DROP-TABLE-DROP-TABLE-1
  :PARAMETERS ( ?AGENT0 - AGENT ?TABLE2 - TABLE ?ROOM3 - ROOM ?AGENT-COUNT4 - AGENT-COUNT ?AGENT-COUNT5 - AGENT-COUNT )
  :PRECONDITION
	( AND
		( IN ?AGENT0 ?ROOM3 )
  ...
  :EFFECT
	( AND
		...
		( IN-JOINT )
		( NEXT-ACTIVITY-DROP-TABLE-DROP-TABLE-2 ?TABLE2 )
		( P-ACTIVITY-DROP-TABLE-DROP-TABLE ?AGENT0 ?TABLE2 )
		( P-DROP-TABLE ?AGENT0 ?TABLE2 )
	)
)
( :ACTION DO-ACTIVITY-DROP-TABLE-DROP-TABLE-2
  :PARAMETERS ( ?AGENT0 - AGENT ?TABLE2 - TABLE ?ROOM3 - ROOM ?AGENT-COUNT4 - AGENT-COUNT ?AGENT-COUNT5 - AGENT-COUNT )
  :PRECONDITION
	( AND
		( IN ?AGENT0 ?ROOM3 )
  ...
  :EFFECT
	( AND
		...
		( NOT ( CHARGED ?AGENT0 ) )
		( NOT ( IN-JOINT ) )
		( NOT ( NEXT-ACTIVITY-DROP-TABLE-DROP-TABLE-2 ?TABLE2 ) )
		( TAKEN ?AGENT0 )
		( NOT ( COUNT-V4 ?AGENT-COUNT4 ) )
		( COUNT-V4 ?AGENT-COUNT5 )
	)
...
( :ACTION END-V4
  ...
  :EFFECT
	( AND
		...
		( FORALL
			( ?AGENT2 - AGENT )
			( NOT ( P-ACTIVITY-DROP-TABLE-DROP-TABLE ?AGENT2 ?TABLE0 ) )
		)
		( FORALL
			( ?AGENT2 - AGENT )
			( NOT ( TAKEN ?AGENT2 ) )
...
;Total compilation time = 0.00204
