...
( :PREDICATES
	...
	( AFREE )
	( IN-JOINT )
	( P-ACTIVITY-PUSH-BOX-PUSH-BOX ?AGENT0 - AGENT ?BOX1 - BOX ?LOCATION2 - LOCATION ?LOCATION3 - LOCATION )
	( P-PUSH-BOX ?AGENT0 - AGENT ?BOX1 - BOX ?LOCATION2 - LOCATION ?LOCATION3 - LOCATION )
	( NEXT-ACTIVITY-PUSH-BOX-PUSH-BOX-2 ?BOX0 - BOX ?LOCATION1 - LOCATION ?LOCATION2 - LOCATION )
...
( :ACTION DO-PUSH-BOX
  ...
  :PRECONDITION
	( AND
		...
		( NOT ( P-ACTIVITY-PUSH-BOX-PUSH-BOX ?AGENT0 ?BOX1 ?LOCATION2 ?LOCATION3 ) )
		( FORALL
			( ?AGENT6 - AGENT )
			( AND
...
( :ACTION DO-ACTIVITY-PUSH-BOX-PUSH-BOX-1
  ...
  :PRECONDITION
	( AND
		...
		( NOT ( P-PUSH-BOX ?AGENT0 ?BOX2 ?LOCATION3 ?LOCATION4 ) )
	)
  :EFFECT
	( AND
		...
		( IN-JOINT )
		( NEXT-ACTIVITY-PUSH-BOX-PUSH-BOX-2 ?BOX2 ?LOCATION3 ?LOCATION4 )
		( P-ACTIVITY-PUSH-BOX-PUSH-BOX ?AGENT0 ?BOX2 ?LOCATION3 ?LOCATION4 )
		( P-PUSH-BOX ?AGENT0 ?BOX2 ?LOCATION3 ?LOCATION4 )
	)
)
( :ACTION DO-ACTIVITY-PUSH-BOX-PUSH-BOX-2
  :PARAMETERS ( ?AGENT0 - AGENT ?BOX2 - BOX ?LOCATION3 - LOCATION ?LOCATION4 - LOCATION ?AGENT-COUNT5 - AGENT-COUNT ?AGENT-COUNT6 - AGENT-COUNT )
  :PRECONDITION
	( AND
		( AGENT-AT-LOC ?AGENT0 ?LOCATION3 )
  ...
  :EFFECT
	( AND
		...
		( NEG-BOX-AT-LOC ?BOX2 ?LOCATION3 )
		( NOT ( IN-JOINT ) )
		( NOT ( NEXT-ACTIVITY-PUSH-BOX-PUSH-BOX-2 ?BOX2 ?LOCATION3 ?LOCATION4 ) )
		( TAKEN ?AGENT0 )
		( NOT ( COUNT-V2 ?AGENT-COUNT5 ) )
		( COUNT-V2 ?AGENT-COUNT6 )
	)
  ...
  :EFFECT
	( AND
		...
		( FORALL
			( ?AGENT6 - AGENT )
			( AND	
			( NOT ( P-ACTIVITY-PUSH-BOX-PUSH-BOX ?AGENT6 ?BOX0 ?LOCATION1 ?LOCATION2 ) ) ) )
		( FORALL
			( ?AGENT4 - AGENT )
			( NOT ( TAKEN ?AGENT4 ) )
		)
  ...
  :EFFECT
	( AND
		...
		( FORALL
			( ?AGENT6 - AGENT )
			( AND
				( NOT ( P-MOVE-AGENT ?AGENT6 ?LOCATION0 ?LOCATION1 ) ) ) )
		( FORALL
			( ?AGENT3 - AGENT )
			( NOT ( TAKEN ?AGENT3 ) )
		)
...
;Total compilation time = 0.001389
